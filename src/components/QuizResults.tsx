  ...
  return (
    <div className="relative">
      ...
      <div className="bg-white rounded-lg shadow-lg p-8 max-w-2xl w-full relative z-10 animate-fade-in">
        ...
        <button
          onClick={startQuiz}
          className="w-full flex items-center justify-center gap-2 px-6 py-3 rounded-xl bg-gradient-to-r from-blue-600 to-blue-700 text-white hover:from-blue-700 hover:to-blue-800 transition-all duration-200 font-medium shadow-lg hover:shadow-xl"
        >
